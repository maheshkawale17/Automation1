...
public class InstagramLogin {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@name='username']")).sendKeys("mahesh@123");
...
// Without providing Thread.sleep()(Static wait) we will get an exception called NoSuchElementException  
	}
